...
#ifndef HX_DEPOT_SFML_RESOURCEMANAGERBASIC_HPP
#define HX_DEPOT_SFML_RESOURCEMANAGERBASIC_HPP

#include <SFML/Graphics/Font.hpp>
#include <SFML/Graphics/Image.hpp>
#include <SFML/Graphics/Texture.hpp>
#include <SFML/Audio/SoundBuffer.hpp>
#include <Hx/Plinth/IndexedMap.hpp>
#include <vector>
...
private:
	hx::IndexedMap<std::string, sf::Font> m_fonts;
	hx::IndexedMap<std::string, sf::Image> m_images;
	hx::IndexedMap<std::string, sf::Texture> m_textures;
	hx::IndexedMap<std::string, sf::SoundBuffer> m_soundBuffers;
};
...
#endif // HX_DEPOT_SFML_RESOURCEMANAGERBASIC_HPP
...
#ifndef HX_KAIROS_TIMER_HPP
#define HX_KAIROS_TIMER_HPP
...
public:
	...
	bool isDone(); // returns true if timer has finished
	bool isPaused(); // returns true if timer has finished

...
// Quadratic Bezier calculator

// quadratic bezier only (faster calculations than flexible order bezier)
...
#ifndef HX_PLINTH_BEZIER_QUADRATIC_HPP
#define HX_PLINTH_BEZIER_QUADRATIC_HPP
...
#endif // HX_PLINTH_BEZIER_QUADRATIC_HPP
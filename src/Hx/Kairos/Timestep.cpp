...
double Timestep::getInterpolationAlpha()
{
	return m_accumulator < m_step ? m_accumulator / m_step : 1.0;
}

float Timestep::getInterpolationAlphaAsFloat()
{
...
double Timestep::getOverall()
{
	return (m_overall > m_step) ? m_overall - m_step : 0.0;
}

float Timestep::getOverallAsFloat()
{
...
bool Timestep::shouldBeZero(double a)
{
